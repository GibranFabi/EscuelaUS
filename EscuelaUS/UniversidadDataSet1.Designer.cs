...
namespace EscuelaUS {
    ...
    public partial class UniversidadDataSet1 : global::System.Data.DataSet {
        ...
        public partial class AlumnoDataTable : global::System.Data.TypedTableBase<AlumnoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AlumnoRow AddAlumnoRow(string nombre, int calificacion) {
        ...
        public partial class AlumnoRow : global::System.Data.DataRow {
            ...
            public int calificacion {
                get {
                    return ((int)(this[this.tableAlumno.calificacionColumn]));
                }
                set {
                    this[this.tableAlumno.calificacionColumn] = value;
                }
            }
        }
...
namespace EscuelaUS.UniversidadDataSet1TableAdapters {
    ...
    public partial class AlumnoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Alumno] WHERE (([AlumnoID] = @Original_AlumnoID) AND ([nombre]" +
                " = @Original_nombre) AND ([calificacion] = @Original_calificacion))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Alumno] ([nombre], [calificacion]) VALUES (@nombre, @calificac" +
                "ion);\r\nSELECT AlumnoID, nombre, calificacion FROM Alumno WHERE (AlumnoID = SCOPE" +
                "_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Alumno] SET [nombre] = @nombre, [calificacion] = @calificacion WHERE (([AlumnoID] = @Original_AlumnoID) AND ([nombre] = @Original_nombre) AND ([calificacion] = @Original_calificacion));
SELECT AlumnoID, nombre, calificacion FROM Alumno WHERE (AlumnoID = @AlumnoID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EscuelaUS.Properties.Settings.Default.UniversidadConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT AlumnoID, nombre, calificacion FROM dbo.Alumno";
        ...
        public virtual int Fill(UniversidadDataSet1.AlumnoDataTable dataTable) {
        ...
        public virtual UniversidadDataSet1.AlumnoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UniversidadDataSet1.AlumnoDataTable dataTable = new UniversidadDataSet1.AlumnoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UniversidadDataSet1.AlumnoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_AlumnoID, string Original_nombre, int Original_calificacion) {
        ...
        public virtual int Insert(string nombre, int calificacion) {
            if ((nombre == null)) {
        ...
        public virtual int Update(string nombre, int calificacion, int Original_AlumnoID, string Original_nombre, int Original_calificacion, int AlumnoID) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(Original_AlumnoID));
            if ((Original_nombre == null)) {
                throw new global::System.ArgumentNullException("Original_nombre");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(AlumnoID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, int calificacion, int Original_AlumnoID, string Original_nombre, int Original_calificacion) {
            return this.Update(nombre, calificacion, Original_AlumnoID, Original_nombre, Original_calificacion, Original_AlumnoID);
        }
    }
